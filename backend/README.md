...
## Project Structure
    ...
    ├── testapiautosetting_127281  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127281`
...
2. Clone this repo and `cd testapiautosetting_127281`
